...
//        var data = await JsonSerializer.DeserializeAsync<ModelRawCollection>(stream, cancellationToken: ct);
...
//            .Select(a => new Model(a.name!, a.size!,a.modified_at!))];
//    }
...
//        var agentResponse =
//            JsonSerializer.Deserialize<Response>(agentResponseString)
